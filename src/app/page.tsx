  ...
  <div className="container text-center h-screen p-5 flex items-center justify-center">
      <div className="flex flex-col justify-center ">
       ...
       <div className="flex gap-4 justify-center mt-4">
        <Link href={"/products"}><Button className="md:px-9 cursor-pointer py-6 text-lg">Shop Now</Button></Link>
        <Link href={"/categories"}><Button className="md:px-9 cursor-pointer py-6 text-lg border border-accent-foreground" variant="outline">Browse categories</Button></Link>
